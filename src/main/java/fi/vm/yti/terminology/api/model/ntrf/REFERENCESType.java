 ...
 *                     &lt;/complexType>
 *                   &lt;/element>
 *                   &lt;element name="REFLINK" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class REFERENCESType {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "REFHEAD", type = REFERENCESType.REFHEAD.class)
    })
    ...
    public static class REFHEAD {

        @XmlElementRefs({
            @XmlElementRef(name = "REFLINK", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "REFNAME", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "REFTEXT", type = JAXBElement.class, required = false)
        })
        @XmlMixed
         ...
         * {@link String }
         * {@link JAXBElement }{@code <}{@link String }{@code >}
         * {@link JAXBElement }{@code <}{@link REFERENCESType.REFHEAD.REFTEXT }{@code >}
         * 
         * 
         */
