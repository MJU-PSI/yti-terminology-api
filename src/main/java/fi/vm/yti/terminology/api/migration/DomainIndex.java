...
public final class DomainIndex {
    ...
    public static final UUID TERMINOLOGICAL_VOCABULARY_TEMPLATE_GRAPH_ID = UUID.fromString("61cf6bde-46e6-40bb-b465-9b2c66bf4ad8");
    public static final UUID VOCABULARY_TEMPLATE_GRAPH_ID = UUID.fromString("b387af64-4c66-4542-95f3-4c33c6831fcc");
    ...
    public static final TypeId CONCEPT_DOMAIN =
            new TypeId(NodeType.Concept, new GraphId(VOCABULARY_TEMPLATE_GRAPH_ID));

    public static final TypeId VOCABULARY_TEMPLATE_DOMAIN =
            new TypeId(NodeType.Concept, new GraphId(VOCABULARY_TEMPLATE_GRAPH_ID));

    public static final TypeId COLLECTION_TEMPLATE_DOMAIN =
            new TypeId(NodeType.Concept, new GraphId(VOCABULARY_TEMPLATE_GRAPH_ID));

    public static final TypeId TERMINOLOGICAL_CONCEPT_TEMPLATE_DOMAIN =
            new TypeId(NodeType.Concept, new GraphId(TERMINOLOGICAL_VOCABULARY_TEMPLATE_GRAPH_ID));
    ...
    public static final TypeId TERMINOLOGICAL_COLLECTION_TEMPLATE_DOMAIN =
            new TypeId(NodeType.Collection, new GraphId(TERMINOLOGICAL_VOCABULARY_TEMPLATE_GRAPH_ID));

    public static final TypeId TERM_TEMPLATE_DOMAIN =
            new TypeId(NodeType.Term, new GraphId(TERMINOLOGICAL_VOCABULARY_TEMPLATE_GRAPH_ID));
